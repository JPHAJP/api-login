...
VALUES
    ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-08 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-08 15:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-15 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-15 15:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-22 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-22 15:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-29 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-29 15:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-09 16:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-09 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-16 16:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-16 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-23 16:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-23 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-30 16:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-30 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-10 10:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-10 12:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-17 10:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-17 12:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-24 10:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-24 12:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-31 10:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-31 12:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-11 14:30', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-11 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-18 14:30', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-18 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-25 14:30', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-25 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-04 14:30', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha2@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-04 18:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-12 11:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-12 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-12 17:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-12 20:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-19 11:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-19 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-19 17:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-19 20:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-26 11:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-26 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-26 17:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-26 20:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-05 11:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-05 13:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'ENTRY',
        TO_TIMESTAMP('2025-12-05 17:00', 'YYYY-MM-DD HH24:MI'),
        FALSE),
       ((SELECT id FROM public.users pu WHERE pu.email = 'josepabloha3@live.com.mx'),
        (SELECT id FROM qr_codes WHERE is_active = TRUE),
        'EXIT',
        TO_TIMESTAMP('2025-12-05 20:00', 'YYYY-MM-DD HH24:MI'),
        FALSE);
...
SELECT * FROM public.v_user_hours_report;
SELECT * FROM public.fn_user_hours_report(TO_DATE('2025-11-01', 'YYYY-MM-DD'), TO_DATE('2025-12-31', 'YYYY-MM-DD'), 'week');
SELECT * FROM public.v_user_hours_report;
SELECT * FROM public.fn_user_hours_report(TO_DATE('2025-11-01', 'YYYY-MM-DD'), TO_DATE('2025-11-30', 'YYYY-MM-DD'), 'month');
SELECT * FROM public.v_user_hours_report;
SELECT * FROM public.fn_user_hours_report(TO_DATE('2025-11-01', 'YYYY-MM-DD'), TO_DATE('2025-12-31', 'YYYY-MM-DD'), 'month');
SELECT * FROM public.v_user_hours_report;
